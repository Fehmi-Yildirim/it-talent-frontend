        ...
        <main className="landing-page">
            ...
            <section className="landing-hero">
                <div className="landing-hero-content">
                    ...
                    <p className="landing-hero-description">
                        IT Talent helps candidates and recruiters connect
                        through a focused platform for the IT job market.
                    </p>
            ...
            <section className="landing-audience">
                <article className="landing-card">
                    ...
                    <p>
                        Create your profile and present your skills and
                ...
                <article className="landing-card">
                    ...
                    <p>
                        Build your recruiter profile and connect with
                        professionals for your hiring needs.
                    </p>
