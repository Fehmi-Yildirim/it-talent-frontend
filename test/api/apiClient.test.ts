...
describe('apiClient', () => {
  ...
  it('throws ApiError for HTTP errors', async () => {
    ...
    const request = apiClient.post('/auth/login', {
      email: 'test@example.com',
  ...
  it('preserves the backend HTTP status', async () => {
    ...
    try {
      ...
      expect(apiError.message).toBe('Unable to create account')
    }
  })
  ...
  it('handles validation error message arrays', async () => {
    ...
    try {
      ...
      expect(apiError.details?.message).toEqual(details.message)
    }
  })
  ...
  it('handles network errors', async () => {
    ...
    try {
      ...
      expect(apiError.message).toBe('Unable to connect to the API')
      expect(apiError.details?.cause).toBe(networkError)
    }
  })
  ...
  it('handles successful empty JSON objects', async () => {
    ...
    const result = await apiClient.get<Record<string, never>>('/health')
